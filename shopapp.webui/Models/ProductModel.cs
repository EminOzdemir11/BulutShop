...
namespace shopapp.webui.Models
{
    public class ProductModel
    {
        ...
        //[StringLength(60,MinimumLength=5,ErrorMessage="Ürün ismi 5-100 karakter arasında olmalıdır.")]
        ...
        //[Range(1,10000,ErrorMessage="Price için 1-10000 arasında bir değer girmelisiniz.")]
